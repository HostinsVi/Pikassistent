    ...
    <div className="landingPage_container">
      ...
      <main className="landingPage_content">
        ...
        <section className="elementsInfo_container">
            ...
            <div className="p_container">
              <div className="textWhy_container animate-on-scroll">
                ...
                <div className="textWhy_content">
                  <p>
                    Percebemos que muitos treinadores enfrentam dificuldades
                    para encontrar informações confiáveis, montar times
                    competitivos e compartilhar experiências. O Pikassistent
                    nasceu para solucionar esses problemas, criando um hub
                    completo para a comunidade Pokémon brasileira.
                  </p>
                </div>
              </div>
              ...
              <div className="textWhy_container animate-on-scroll">
                ...
                <div className="textWhy_content">
                  <p>
                    Combinamos tecnologia de ponta com conhecimento
                    especializado em Pokémon. Usamos IA avançada para análises
                    estratégicas, criamos uma comunidade ativa para troca de
                    experiências e desenvolvemos ferramentas intuitivas para
                    todos os níveis de treinadores.
                  </p>
                </div>
              </div>
            </div>
          ...
          <h2 className="features_title animate-on-scroll">
            O Que Oferecemos:
          </h2>

          <section className="features_container">
            <p className="features-intro animate-on-scroll">
              Nós disponibilizamos tecnologias inovadoras para auxiliar em sua
              jornada Pokémon:
            </p>

            <div className="feature_card pokedexInfo animate-on-scroll">
            ...
            <div className="feature_card chatBotInfo animate-on-scroll">
              <div className="feature_icon">
            ...
            <div className="feature_card chatGlobalInfo animate-on-scroll">
              <div className="feature_icon">
            ...
            <div className="cta-final animate-on-scroll">
              ...
              <p>
                Junte-se a milhares de treinadores e descubra todo o potencial
                do mundo Pokémon com o Pikassistent. Totalmente gratuito e
                desenvolvido por fãs, para fãs!
              </p>
            </div>
          </section>
          <div className="cta_buttons">
            <button className="primary_cta" onClick={() => navigate("/signup")}>
              Criar Conta Grátis
            </button>
            <button
        ...
        <footer className="landing-footer">
          <div className="footer-content">
            <div className="footer-info">
              <p>
                <span>Pikassistent</span> - Seu companheiro na jornada Pokémon
              </p>
            </div>
            <div className="footer-disclaimer">
              <p>
                ⚠️ Este projeto foi desenvolvido para uma atividade acadêmica e
                não tem nenhum intuito monetário. Pokémon é uma marca registrada
                da Nintendo.
              </p>
            </div>
          </div>
