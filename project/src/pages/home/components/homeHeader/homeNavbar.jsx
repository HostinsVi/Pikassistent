  ...
  return (
    <>
      <section className="navbar">
        <section className="navMenu_container">
          <button className="navMenu_button" onClick={showSidebar}>
            <img src={menuIcon} alt="" />
            <span>Menu</span>
          </button>
        </section>
        <nav className="sidebar_container" style={sidebar ? { display: "flex" } : { display: "none" }}>
          {/* <ul */}
          <ul
            className={sidebar ? "nav-menu-items" : "nav-menu-items"}
            onClick={showSidebar}
          >
            {SidebarData.map((item, index) => {
              return (
                <li key={index} className={`${item.cName} sidebar_item`}>
                  <Link to={item.path}>
        ...
        {/* <nav className={sidebar ? "nav-menu active" : "nav-menu"}>
          <div className={sidebar ? "nav-btn-container active" : "nav-btn-container"}>
            <button className="nav-btn" onClick={showSidebar}>Menu</button>
